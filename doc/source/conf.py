...
sphinx_gallery_conf = {
    "doc_module": "dataify",
    "backreferences_dir": os.path.join("dataify", "gallery"),
    "examples_dirs": os.path.join(os.pardir, "examples"),
    "gallery_dirs": "auto_gallery",
    "reference_url": {"dataify": None}}
...
project = u"dataify"
copyright = u"""{0}, dataify developers <antoine.grigis@cea.fr>""".format(
...
# [howto/manual]).
latex_documents = [
    ("index", "dataify.tex", "dataify Documentation", """dataify developers""",
     "manual"),
]
